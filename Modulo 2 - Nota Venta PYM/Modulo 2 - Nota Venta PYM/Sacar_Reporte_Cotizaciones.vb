...
Public Class Sacar_Reporte_Cotizaciones
    ...
    End Sub
    Private Sub Sacar_Reporte_Cotizaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        NotaVenta.Panel3.Visible = False
        ...
        Cotizaciones.valor_orden_venta()
        Cotizaciones.crear_16_filas()
    End Sub
    ...
    End Sub
    Private Sub Sacar_Reporte_Cotizaciones_MouseMove(sender As Object, e As MouseEventArgs) Handles Me.MouseMove
        If allowResize Then
        ...
        End If
    End Sub
    Private Sub Sacar_Reporte_Cotizaciones_MouseDown(sender As Object, e As MouseEventArgs) Handles Me.MouseDown
        allowResize = True
        Me.Cursor = Cursors.SizeNWSE
    End Sub
    Private Sub Sacar_Reporte_Cotizaciones_MouseUp(sender As Object, e As MouseEventArgs) Handles Me.MouseUp
        allowResize = False
        Me.Cursor = Cursors.Default
    End Sub
End Class