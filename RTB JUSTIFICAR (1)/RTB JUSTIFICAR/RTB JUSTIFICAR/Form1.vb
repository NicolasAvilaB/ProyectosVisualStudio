...
Public Class Form1
    ...
    Private Sub ButtonIZQUIERDA_Click(sender As System.Object, e As System.EventArgs) Handles ButtonIZQUIERDA.Click
        AdvRichTextBox1.SelectionAlignment = TextAlign.Left
    End Sub

    Private Sub ButtonCENTRO_Click(sender As System.Object, e As System.EventArgs) Handles ButtonCENTRO.Click
        AdvRichTextBox1.SelectionAlignment = TextAlign.Center
    End Sub

    Private Sub ButtonDERECHA_Click(sender As System.Object, e As System.EventArgs) Handles ButtonDERECHA.Click
        AdvRichTextBox1.SelectionAlignment = TextAlign.Right
    End Sub

    Private Sub ButtonJUSTIFICAR_Click(sender As System.Object, e As System.EventArgs) Handles ButtonJUSTIFICAR.Click
        AdvRichTextBox1.SelectionAlignment = TextAlign.Justify
    End Sub
End Class

'CODIGO OBTENIDO AQUI: http://geekswithblogs.net/pvidler/archive/2003/10/14/182.aspx Y ADAPTADO A VB.NET
