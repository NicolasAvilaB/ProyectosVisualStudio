...
Public Class Informe_Usuarios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProyBodega.Informe_Usuarios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_Usuarios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_Usuarios = New Informe_Usuarios()
        rpt.Site = Me.Site
        Return rpt
    End Function
