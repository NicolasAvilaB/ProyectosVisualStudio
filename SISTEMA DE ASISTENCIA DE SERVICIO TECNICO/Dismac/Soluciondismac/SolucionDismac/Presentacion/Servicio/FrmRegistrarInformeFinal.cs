...
{
    public partial class FrmRegistrarInformeFinal : Form
    {
        public FrmRegistrarInformeFinal()
        {
            InitializeComponent();
        }

        private void FrmRegistrarInformeFinal_Load(object sender, EventArgs e)
        {
            try
            {
                try
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Primero debe tener un informe preliminar \n para luego registrar el ultimo Informe..", "SAT Informa", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                obj.PidInforme = 0;
                obj.PfechaInforme = DateTime.Parse(this.dtpFechaInforme.Value.ToString());
                obj.PobsInforme = this.listDesperfectos.Text.Trim() + " \r" + this.textBox1.Text.Trim();
                obj.PiConcurrenciaInforme = 0;
                obj.PidOrdenTrabajo = int.Parse(this.lblNroOrden.Text);
                obj.PidDesperfecto = int.Parse(this.cboDesperfectoInforme.SelectedValue.ToString());
                if (obj.Modificar() == 1)
