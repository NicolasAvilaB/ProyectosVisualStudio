...
Public Class Impresion_HistorialInsertoArticulos
    ...
    Private Sub Panel2_MouseUp(sender As Object, e As MouseEventArgs) Handles Panel2.MouseUp
        ...
        Me.Cursor = Cursors.Default
    End Sub
    Private Sub Impresion_HistorialInsertoArticulos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
