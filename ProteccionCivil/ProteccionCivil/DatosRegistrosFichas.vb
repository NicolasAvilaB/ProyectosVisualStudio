Public Class DatosRegistrosFichas
    ...
    Sub Actualizacion_Tabla_Base_Fichas()
        Consulta1("Call MostrarGrillaRegistrosFichas")
    End Sub
    ...
    Private Sub Label5_MouseUp(sender As Object, e As MouseEventArgs) Handles Label5.MouseUp
        ...
        Me.Cursor = Cursors.Default
    End Sub
    Private Sub DatosRegistrosFichas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
