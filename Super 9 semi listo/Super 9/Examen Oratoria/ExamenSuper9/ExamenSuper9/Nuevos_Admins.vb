Public Class Nuevos_Admins
    ...
    Private Sub Ver4_Click(sender As Object, e As EventArgs) Handles Ver4.Click
        ...
        Else
            Clave.PasswordChar = ""
            Ver4.Enabled = False
            Ocultar4.Enabled = True
            Clave.Focus()
        End If
    End Sub

    Private Sub Ocultar4_Click(sender As Object, e As EventArgs) Handles Ocultar4.Click
        If (Clave.Text = "") Then
            MsgBox("Error: No Hay Nada Escrito, Por favor Escriba Su Contraseña", vbCritical, "Error Fatal")

        Else
            Clave.PasswordChar = "*"
            Ocultar4.Enabled = False
            Ver4.Enabled = True
            Clave.Focus()
        End If
    End Sub

    Private Sub GrillaAdmins_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles GrillaAdmins.CellContentClick
