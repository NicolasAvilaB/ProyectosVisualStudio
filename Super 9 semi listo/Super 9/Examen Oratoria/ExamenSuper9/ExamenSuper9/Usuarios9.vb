Public Class Usuarios9
    ...
    Private Sub Primero_Click_1(sender As Object, e As EventArgs)

    End Sub

    Private Sub Anterior_Click_1(sender As Object, e As EventArgs)

    End Sub

    Private Sub Siguiente_Click_1(sender As Object, e As EventArgs)

    End Sub

    Private Sub Ultimo_Click_1(sender As Object, e As EventArgs)
    ...
    Private Sub TxtCajero_TextChanged_1(sender As Object, e As EventArgs) Handles TxtCajero.TextChanged
    ...
    Private Sub Ocultar2_Click(sender As Object, e As EventArgs)
    ...
    Private Sub Ocultar3_Click(sender As Object, e As EventArgs)
    ...
    Private Sub GrillaUsuarios_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles GrillaUsuarios.CellContentClick
