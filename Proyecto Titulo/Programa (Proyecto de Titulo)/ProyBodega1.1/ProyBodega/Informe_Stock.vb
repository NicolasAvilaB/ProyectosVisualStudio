...
Public Class Informe_Stock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProyBodega.Informe_Stock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInforme_Stock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Informe_Stock = New Informe_Stock()
        rpt.Site = Me.Site
        Return rpt
    End Function
