...
Public Class Efectivo1
    ...
    Private Sub Aceptar_Click(sender As Object, e As EventArgs) Handles Aceptar.Click
        ...
        ElseIf (Convert.ToInt64(Pago.Text) = Convert.ToInt64(TotalVenta.Text)) Then
            ...
            ' For Each dr As DataGridViewRow In EmitirBoletas.Productos_Pasados.Rows
            '     dt.Rows.Add(dt.Columns("Nombre").ToString, dt.Columns("Cantidad").ToString, dt.Columns("Precio").ToString)
            'Next


            Dim GR As New GrillaRemito

            For Each row As DataGridViewRow In EmitirBoletas.Productos_Pasados.Rows

                GR.DataTable1.AddDataTable1Row(row.Cells(1).Value.ToString, row.Cells(3).Value.ToString, row.Cells(2).Value.ToString)
