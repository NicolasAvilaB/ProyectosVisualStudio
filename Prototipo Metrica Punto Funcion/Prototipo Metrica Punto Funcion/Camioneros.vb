Public Class Camioneros
    ...
    Private Sub cerrar_Click(sender As Object, e As EventArgs) Handles cerrar.Click
        ...
        Menu1.Show()
    End Sub
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles camiones.Click
        Hide()
        Camioness.Show()
    End Sub
    ...
    End Sub
    Private Sub camiones_MouseMove(sender As Object, e As MouseEventArgs) Handles camiones.MouseMove
        camiones.BackColor = Color.White
        camiones.ForeColor = Color.FromArgb(0, 77, 64)
    End Sub
    Private Sub camiones_MouseLeave(sender As Object, e As EventArgs) Handles camiones.MouseLeave
        camiones.BackColor = Color.FromArgb(0, 77, 64)
        camiones.ForeColor = Color.White
    End Sub

    Private Sub Camioneros_Load(sender As Object, e As EventArgs) Handles MyBase.Load
