...
Begin VB.Form FrmNotaSalidaBuscar 
   BackColor       =   &H00B0726D&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BUSCAR NOTA DE SALIDA"
   ClientHeight    =   10050
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   15270
   ForeColor       =   &H00B0726D&
   Icon            =   "FrmNotaSalidaBuscar.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   10050
   ...
   Begin VB.CommandButton CmdSalir 
      ...
      Height          =   855
      Left            =   13680
      Picture         =   "FrmNotaSalidaBuscar.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   120
      Width           =   1455
   ...
   End
End
Attribute VB_Name = "FrmNotaSalidaBuscar"
...
Centrar_Objeto Me
P_KARDEXBUSQUEDANOTASALI MSHFlexGrid1, 1
End Sub
...
With FrmNotaSalida
  ...
  .cmbcliente = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 8)
  .txtsubtotal = Format$(P_RELLENADETALLEKARDEX(.MSHFlexGrid1, "S" + .txtNK), "###.00")
  .cmbpromotor = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 9)
  If MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 10) = "1" Then .optsoles.Value = True
  If MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 10) = "2" Then .optdolares.Value = True
  .txttipocambio = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 11)
  .Nuevok = True
  .CMDNUEVO1_Click
...
If optningreso.Value = True Then
  P_KARDEXBUSQUEDANOTASALI MSHFlexGrid1, 2, Trim$(txtbuscar)
  Exit Sub
End If
If optmotivo.Value = True Then
  P_KARDEXBUSQUEDANOTASALI MSHFlexGrid1, 3, Trim$(txtbuscar)
  Exit Sub
End If
If optdocumento.Value = True Then
  P_KARDEXBUSQUEDANOTASALI MSHFlexGrid1, 4, Trim$(txtbuscar)
  Exit Sub
End If
If optfecha.Value = True Then
  P_KARDEXBUSQUEDANOTASALI MSHFlexGrid1, 5, Trim$(txtbuscar)
  Exit Sub
End If
If optcliente.Value = True Then
  P_KARDEXBUSQUEDANOTASALI MSHFlexGrid1, 6, Trim$(txtbuscar)
  Exit Sub
End If
End Sub
