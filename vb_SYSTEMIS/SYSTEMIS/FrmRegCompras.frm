...
Begin VB.Form FrmRegCompras 
   ...
   Begin VB.CommandButton CmdSalir 
      ...
      Height          =   855
      Left            =   2040
      Picture         =   "FrmRegCompras.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   1560
      Width           =   1455
   ...
   Begin VB.CommandButton CmdVImprimir 
      ...
      Height          =   855
      Left            =   480
      Picture         =   "FrmRegCompras.frx":0614
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   1560
      Width           =   1455
   ...
   End
End
Attribute VB_Name = "FrmRegCompras"
...
tm1 = Format$(CDate(dtm1.Value), "dd/mm/yyyy")
tm2 = Format$(CDate(dtm2.Value), "dd/mm/yyyy")
V_REGISTRODECOMPRAS = True
End Sub

Private Sub Form_Unload(Cancel As Integer)
V_REGISTRODECOMPRAS = False
End Sub
