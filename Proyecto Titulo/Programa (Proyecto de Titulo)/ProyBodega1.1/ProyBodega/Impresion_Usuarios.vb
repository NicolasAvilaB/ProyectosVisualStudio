...
Public Class Impresion_Usuarios
    Private x As Integer
    Private y As Integer
    Private mover As Boolean
    Declare Function SetDefaultPrinter Lib "winspool.drv" Alias "SetDefaultPrinterA" (ByVal pszPrinter As String) As Boolean
    Private Sub Impresion_Usuarios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub impresion_Click(sender As Object, e As EventArgs) Handles impresion.Click
        Dim orpt As New Informe_Usuarios
        Dim Dt As New DataTable
        Dt = Usuarios.Grilla_Usuarios.DataSource
        Dim Cr As New Informe_Usuarios
        Cr.SetDataSource(Dt)
        orpt.Load("Informe_Usuarios.rpt")
