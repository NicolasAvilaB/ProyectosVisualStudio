...
Public Class BoletaValidador
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProyBodega.BoletaValidador.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Codigo_Articulo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBoletaValidador
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BoletaValidador = New BoletaValidador()
        rpt.Site = Me.Site
        Return rpt
    End Function
