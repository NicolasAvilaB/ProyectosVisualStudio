Public Class Entrada
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Ingreso.Click
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Ver.Click
