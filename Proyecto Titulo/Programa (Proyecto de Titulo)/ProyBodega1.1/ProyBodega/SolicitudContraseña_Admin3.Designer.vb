...
Partial Class SolicitudContraseña_Admin3
    ...
    Private Sub InitializeComponent()
        ...
        Me.Mensajes.SetToolTip(Me.Ver2, "Muestre y/o Oculte la Clave o Contraseña Digitada")
        ...
        Me.Mensajes.SetToolTip(Me.contra, "Ingrese Contraseña o Clave del Alias")
        '
        'nombre
        '
        ...
        Me.Mensajes.SetToolTip(Me.nombre, "Ingrese algun Alias Registrado")
        '
        'cierre
        '
