...
Public Class Impresion_IngresoStock
    Private x As Integer
    Private y As Integer
    Private mover As Boolean
    Declare Function SetDefaultPrinter Lib "winspool.drv" Alias "SetDefaultPrinterA" (ByVal pszPrinter As String) As Boolean
    Private Sub Impresion_IngresoStock_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Label5_MouseUp(sender As Object, e As MouseEventArgs) Handles Label5.MouseUp
        ...
        Me.Cursor = Cursors.Default
    End Sub
    Private Sub impresion_Click(sender As Object, e As EventArgs) Handles impresion.Click
        Dim orpt As New Informe_Stock
        Dim Dt As New DataTable
        Dt = Reponer_Stock.Grilla_Stock.DataSource
        Dim Cr As New Informe_Stock
        Cr.SetDataSource(Dt)
        orpt.Load("Informe_Stock.rpt")
