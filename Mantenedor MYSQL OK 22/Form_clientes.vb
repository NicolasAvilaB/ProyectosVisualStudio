Public Class Form_clientes
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If VarSeleccion = 1 Then
            MiConsulta("INSERT INTO clientes (RUT,NOMBRE,DIRECCION,TELEFONO) VALUES ('" & (txt_rut.Text) & "','" & (txt_nombre.Text) & "','" & (txt_direccion.Text) & "'," & (txt_telefono.Text) & ")")
            DA.SelectCommand = SC
            DA.Fill(DT)
            MsgBox("Datos Ingresados Correctamente")

        ElseIf VarSeleccion = 2 Then
            MiConsulta("UPDATE clientes SET NOMBRE='" & (txt_nombre.Text) & "', DIRECCION='" & (txt_direccion.Text) & "',TELEFONO =" & (txt_telefono.Text) & " where RUT='" & (txt_rut.Text) & "'")
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        ...
        If valormensaje = vbYes Then
            MiConsulta("delete from clientes where rut ='" & (txt_rut.Text) & "' ")
